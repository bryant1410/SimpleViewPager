...
public class SimpleViewPager extends RelativeLayout {
  ...
  public void setup(Drawable[] drawables, ImageView.ScaleType scaleType, int indicatorColor,
  ...
  public void setup(String[] imageUrls, int indicatorColor, int selectedIndicatorColor,
